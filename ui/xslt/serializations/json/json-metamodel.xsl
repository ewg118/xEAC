...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xeac="https://github.com/ewg118/xEAC"
    ...
    <xsl:template match="*">
        <xsl:choose>
            <xsl:when test="self::_">
                <xsl:call-template name="xeac:evaluateDatatype">
